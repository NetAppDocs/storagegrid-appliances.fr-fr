...
* Vous devez être connecté au Grid Manager à l'aide d'un https://docs.netapp.com/us-en/storagegrid-118/admin/web-browser-requirements.html["navigateur web pris en charge"^].
...
Si le contrôleur défectueux comprend un HIC, déplacer le HIC du contrôleur défectueux vers le contrôleur de remplacement.
