...
---
= Remplacez le contrôleur de stockage de la série E2800 dans le SG5700
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: *Risque d'endommagement matériel* – La bride métallique située à l'avant de la batterie doit être complètement insérée dans son logement sur le contrôleur (comme illustré sur la première figure). Si la batterie n'est pas correctement installée (comme illustré sur la deuxième figure), la bride métallique risque d'entrer en contact avec la carte du contrôleur et de l'endommager.
...
** *Incorrect – La bride métallique de la batterie n'est pas insérée dans la fente du contrôleur :*
+
