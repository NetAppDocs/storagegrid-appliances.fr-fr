...
---
= Remplacez la pile CMOS dans un SG100 ou un SG1000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Avant de commencer
* Vous avez link:verify-component-to-replace-sg100-and-sg1000.html["Vérifiez que la pile CMOS du SG100 ou du SG1000 doit être remplacée - effectué"].
* Vous avez link:locating-controller-in-data-center.html["Emplacement physique de l'appliance SG100 ou SG1000"] là où vous remplacez la pile CMOS dans le centre de données.
+

NOTE: Un link:shut-down-sg100-and-sg1000.html["arrêt contrôlé de l'appareil"] est nécessaire avant de retirer l'appareil du rack.

* Vous avez déconnecté tous les câbles et link:reinstalling-sg100-and-sg1000-controller-cover.html["retirez le capot de l'appareil - effectué"].
