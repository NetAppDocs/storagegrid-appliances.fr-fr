...
---
= Remplacez le contrôleur E4000 dans un SG5800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** Dans Grid Manager, sélectionnez *Nœuds* > *_nœud d'appliance_* > *SANtricity System Manager*. Les informations du contrôleur se trouvent sur le https://docs.netapp.com/us-en/storagegrid/monitor/viewing-santricity-system-manager-tab.html["Onglet Gestionnaire système SANtricity"^].
