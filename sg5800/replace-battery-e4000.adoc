...
summary:  
---
= Remplacez la pile du contrôleur E4000 dans un SG5800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Il peut s'écouler 20 minutes entre le moment où vous allumez les interrupteurs d'alimentation et le moment où le nœud rejoint le réseau et affiche un état normal dans Grid Manager.
