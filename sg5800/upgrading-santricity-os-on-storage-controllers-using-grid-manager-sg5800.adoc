...
---
= Mettez à niveau SANtricity OS sur les contrôleurs de stockage SG5800 à l'aide de Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour les contrôleurs de stockage qui utilisent SANtricity OS 08.42.20.00 (11.42) ou version ultérieure, vous pouvez utiliser le Gestionnaire de grille pour appliquer une mise à niveau. Vous pouvez également link:upgrading-santricity-os-on-storage-controller.html["utilisez le mode maintenance pour appliquer une mise à niveau"].
