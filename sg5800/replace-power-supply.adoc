...
summary: 'Vous pouvez remplacer un bloc d"alimentation dans le SG5812.' 
---
= Remplacez l'alimentation du SG5812
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer une alimentation dans un SG5812.

.Description de la tâche
Si vous envisagez de remplacer une alimentation électrique, gardez les exigences suivantes à l'esprit.

* Vous devez disposer d'une alimentation de remplacement prise en charge par votre appareil.
...
+
** Bloc d'alimentation de remplacement pris en charge par votre modèle de contrôleur.
...
Préparez-vous à remplacer un bloc d'alimentation.
