...
---
= Assurer la maintenance des appliances SG120 et SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Les procédures spécifiques à l'entretien de votre appareil SG120 ou SG1200 se trouvent dans cette section.
