...
---
= Éteindre et rallumer le SG120 ou le SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez éteindre l'appareil SG120 ou SG1200 et le rallumer pour effectuer la maintenance.



== Éteignez l'appareil SG120 ou SG1200
...
== Mettez sous tension SG120 ou SG1200 et vérifiez son fonctionnement

Mettez le contrôleur sous tension après la fin de la maintenance.

.Avant de commencer
* Vous avez link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["installez le contrôleur dans une armoire ou un rack - effectué"] et connecté les câbles de données et d'alimentation.
* Vous avez link:locating-sg120-and-sg1200-in-data-center.html["situé physiquement le contrôleur dans le data center"].
