...
---
= Remplacez les appliances SG120 ou SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. link:power-sg120-and-sg1200-off-on.html#shut-down-the-sg120-or-sg1200-appliance["Arrêtez l'appareil"].
...
.. link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["Retirez l'appareil défectueux de l'armoire ou du rack"].
.. Notez la position des composants remplaçables (deux alimentations, sept ventilateurs de refroidissement, trois cartes réseau et deux SSD) dans l'appareil défaillant.
+
Les deux disques se trouvent aux emplacements suivants dans le châssis (avant du châssis avec le panneau retiré) :

+
image::../media/sg120_sg1200_ssds_locations.png[Emplacements des disques]
...
CAUTION: Pour conserver les données sur les disques, insérez les disques SSD dans les mêmes emplacements qu'ils occupaient dans l'appliance défaillante. Sinon, l'Appliance Installer affichera un message d'avertissement et vous devrez placer les disques dans les bons emplacements et redémarrer l'appliance avant qu'elle puisse rejoindre de nouveau la grille.

.. link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["Installez l'appareil de remplacement dans l'armoire ou le rack"].
...
* link:../installconfig/troubleshooting-hardware-installation-sg120-and-sg1200.html#view-error-codes["Afficher les codes de démarrage de l'appareil"]
