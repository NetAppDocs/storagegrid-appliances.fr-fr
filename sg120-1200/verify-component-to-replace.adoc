...
---
= Vérifiez le composant à remplacer dans le SG120 ou le SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:turning-sg120-and-sg1200-identify-led-on-and-off.html["Allumez le voyant d'identification de l'appareil"]
