...
---
= Remplacez les piles CMOS d'un SG120 ou SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Utilisez cette procédure pour remplacer les deux piles bouton CMOS sur la carte mère.

.Description de la tâche
Pour éviter toute interruption de service, assurez-vous que tous les autres appliances de services sont connectés à la grille et que les groupes de haute disponibilité ont été configurés (le cas échéant) avant de commencer le remplacement de la pile CMOS ou remplacez les piles pendant une fenêtre de maintenance planifiée lorsque des périodes d'interruption de service sont acceptables. Voir les informations à propos de https://docs.netapp.com/us-en/storagegrid/monitor/monitoring-system-health.html#monitor-node-connection-states["contrôle de l'état de connexion du nœud"^].

.Avant de commencer
* Vous avez link:verify-component-to-replace.html["vérifié le SG120 ou le SG1200 où les piles CMOS doivent être remplacées"].
* Vous avez obtenu les piles CMOS de remplacement correctes (CR2032).
* Vous avez link:locating-sg120-and-sg1200-in-data-center.html["l'appareil SG120 ou SG1200 situé physiquement"] où vous remplacez les piles CMOS dans le centre de données.
