...
summary: 'Vous pouvez arrêter l"appliance SG110 ou SG1100 et la remettre sous tension pour effectuer des opérations de maintenance.' 
---
= Mettre sous tension et hors tension un SG110 ou un SG1100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
