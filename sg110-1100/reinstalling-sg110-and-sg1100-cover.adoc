...
---
= Remplacer le couvercle d'un appareil SG110 ou SG1100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Étapes
. Vérifiez que le loquet du couvercle de l'appareil n'est pas verrouillé. Si nécessaire, tournez le verrou bleu en plastique d'un quart de tour dans le sens du déverrouillage, comme indiqué sur le verrou.
...
+
Si le couvercle n'est pas complètement en place, vous risquez de ne pas pouvoir glisser l'appareil dans le rack.
