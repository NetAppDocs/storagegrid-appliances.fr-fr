...
* Vous avez link:locating-sgf6112-in-data-center.html["Emplacement physique de l'appliance SGF6112"] Emplacement de remplacement de la carte réseau dans le centre de données.
+
