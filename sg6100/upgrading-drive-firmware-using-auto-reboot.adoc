...
---
= Mettre à niveau automatiquement le micrologiciel du lecteur SG6160 lors du redémarrage de l'appareil
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Au cours d'unelink:../sg6100/upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6160.html["Mise à niveau du système d'exploitation SANtricity"] en utilisant le mode maintenance
