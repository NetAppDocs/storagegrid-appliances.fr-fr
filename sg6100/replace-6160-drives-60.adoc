...
---
= Remplacez un disque dans un shelf contrôleur de stockage SG6160 ou tiroir d'extension
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer un disque dans un tiroir de contrôleur de stockage SG6160 ou un tiroir d'extension (DE460C).
