...
. Si le contrôleur SG6100-CN fonctionne suffisamment pour permettre un arrêt contrôlé, link:power-sg6100-cn-controller-off-on.html#shut-down-sg6100-cn-controller["Arrêtez le contrôleur SG6100-CN"].
