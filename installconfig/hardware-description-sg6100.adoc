...
* 4 ports Ethernet 10/25 GbE pour le trafic réseau Grid/Client (ou jusqu'à 4 × 100 GbE avec l'option 100G NIC SKU)
...
4
 a| 
Contrôleur de stockage série E E4000 (1 sur 2) et connecteurs
