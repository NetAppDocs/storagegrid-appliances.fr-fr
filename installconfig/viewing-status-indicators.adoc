...
---
= Consultez les indicateurs d'état et les codes sur les appareils StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* <<appliance_indicators_sg120_sg1200,Voyants et boutons de l'appareil>>
* <<general_boot_codes_sg120_sg1200,Codes de démarrage généraux>>
* <<ssd_indicators_sg120_sg1200,Indicateurs SSD>>


Utilisez ces informations pour vous aider link:troubleshooting-hardware-installation-sg120-and-sg1200.html["Dépanner l'installation matérielle SG120 et SG1200"].

[[appliance_indicators_sg120_sg1200]]
Voyants et boutons de l'appareil::
+
--
La figure suivante montre les indicateurs et les boutons situés sur la face avant des appliances SG120 et SG1200.

image::../media/sg120_sg1200_front_indicators.png[Indicateurs avant - SG120 et SG1200]
...
PFR
 a| 
Ce voyant n'est pas utilisé par les appareils SG120 et SG1200 et reste éteint.

|===
--


La figure ci-dessous illustre l'emplacement de l'alimentation et des voyants d'identification à l'arrière des SG120 et SG1200. Des voyants supplémentaires d'état et d'activité sont présents sur les ports de l'appliance. Ces voyants peuvent varier selon le modèle d'appliance.
...
+
--
La figure suivante présente les indicateurs SSD sur les appliances SG120 et SG1200.
...
* <<appliance_indicators_SG6200,Voyants et boutons de l'appareil>>
* <<general_boot_codes_SG6200,Codes de démarrage généraux>>
* <<ssd_indicators_SG6200,Indicateurs SSD>>


Utilisez ces informations pour vous aider link:troubleshooting-hardware-installation-sg6200.html["Dépanner l'installation matérielle SG6200"].

[[appliance_indicators_SG6200]]
Voyants et boutons de l'appareil::
+
--
La figure suivante illustre les indicateurs et les boutons situés sur la face avant des appliances SG6200.

image::../media/s25_front_indicators.png[Voyants avant - SG6200]
...
PFR
 a| 
Ce voyant n'est pas utilisé par les appareils SG6200 et reste éteint.

|===
--


La figure ci-dessous illustre l'emplacement de l'alimentation et des voyants d'identification à l'arrière des SGF6212 et SG6200-CN. Des voyants supplémentaires d'état et d'activité sont présents sur les ports de l'appliance. Ces voyants peuvent varier selon le modèle d'appliance.

image::../media/s25_rear_leds.png[LED arrière SGF6212 et SG6200-CN]
...
+
--
La figure suivante montre les indicateurs SSD sur l'appliance SGF6212 ou SG6260.
...
*Remarque :* Si un nouveau SSD fonctionnel est inséré dans un nœud StorageGRID SGF6212 ou SG6260 fonctionnel, les LED du SSD doivent clignoter initialement, mais cesser de clignoter dès que le système détermine que le disque a une capacité suffisante et est fonctionnel.
