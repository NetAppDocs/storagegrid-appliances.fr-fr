...
---
= Configurer les liaisons réseau pour une appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:gathering-installation-information-sg120-and-sg1200.html#port-bond-modes["Modes de liaison des ports (SG1200 et SG120)"]
...
* link:gathering-installation-information-sg6200.html#port-bond-modes["Modes de liaison des ports (SGF6212 et SG6200-CN)"]
...
+
--
Les figures montrent comment les quatre ports réseau sur les SG120 et SG1200 sont liés en mode de liaison de port fixe (configuration par défaut).
...
image::../media/sg120_aggregate_ports.png[Mode de liaison du port agrégé SG120]
...
image::../media/sg120_bonded_management_ports.png[Ports réseau d'administration agrégés SG120]

SG1200 :

image::../media/sg1200_bonded_management_ports.png[Ports réseau d'administration agrégés SG1200]
...
image::../media/sgf6212_aggregate_ports.png[Mode de liaison de port agrégé SGF6212]
...
image::../media/sgf6212_bonded_management_ports.png[Ports réseau d'administration agrégés SGF6212]

*SG6200* :

image::../media/sg6200_cn_bonded_management_ports.png[Ports réseau d'administration agrégés SG6200-CN]
...
+
Si vous prévoyez d'utiliser la vitesse de liaison 25 GbE pour les ports réseau SG6200, SG6100, SG6000, SG5800 ou SG5700 :
...
** Pour les SG5800, SG6000, SG6100 ou SG6200, sélectionnez *Auto* dans la liste déroulante *Link speed*.
