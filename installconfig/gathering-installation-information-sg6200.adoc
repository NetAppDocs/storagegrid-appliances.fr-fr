...
---
= Collecter les informations réseau pour le SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Avant d'installer un appareil SGF6212 ou SG6260, confirmez que votre système StorageGRID utilise une version requise du logiciel StorageGRID.
...
Vous connectez les deux contrôleurs de stockage du boîtier SG6260 au réseau de gestion que vous utiliserez pour SANtricity System Manager. Le contrôleur A est placé en haut et le contrôleur B en bas.
...
Ports RJ-45 sur l'appareil SGF6212 :

image::../media/sgf6212_rj_45_ports.png[Ports RJ-45 SGF6212]

Ports RJ-45 sur le contrôleur SG6200-CN :

image::../media/sg6200_cn_rj_45_ports.png[Ports RJ-45 SG6200-CN]
...
Les figures suivantes montrent le port de gestion BMC sur les SGF6212 et SG6200-CN.

_SGF6212_

image::../media/sgf6212_bmc_management_port.png[Port de gestion SGF6212]

_SG6200-CN_

image::../media/sg6200_cn_bmc_management_port.png[port de gestion SG6200-CN]
...
Lorsque link:configuring-network-links.html["configuration des liens réseau"] pour le dispositif SGF6212, vous pouvez utiliser l'agrégation de liens pour les ports connectés au réseau Grid et au réseau client (en option), ainsi que pour les ports de gestion 1/10 GbE connectés au réseau d'administration (en option). L'agrégation de liens contribue à protéger vos données en fournissant des chemins redondants entre les réseaux StorageGRID et le dispositif.
...
image::../media/sgf6212_fixed_port.png[Mode de liaison à port fixe SGF6212]

_SG6200-CN :_

image::../media/sg6200_cn_fixed_port.png[Mode de liaison à port fixe SG6200-CN]
...
image::../media/sgf6212_aggregate_ports.png[Mode de liaison des ports agrégés SGF6212]

_SG6200-CN :_

image::../media/sg6200_cn_aggregate_ports.png[Mode de liaison de port agrégé SG6200-CN]
...
image::../media/sgf6212_bonded_management_ports.png[Ports de gestion de réseau SGF6212]

_SG6200-CN :_

image::../media/sg6200_cn_bonded_management_ports.png[Ports de gestion réseau SG6200-CN]
