...
---
= Collectez les informations réseau pour les SG120 et SG1200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Avant d'installer un dispositif de services SG120 ou SG1200, confirmez que votre système StorageGRID utilise une version requise du logiciel StorageGRID.
...
SG120
 a| 
12.0 ou version ultérieure (dernier correctif recommandé)
...
Ports RJ-45 du SG120 :

image::../media/sg120_rj_45_ports.png[Ports RJ-45 SG120]

Ports RJ-45 du SG1200 :

image::../media/sg1200_rj_45_ports.png[Ports RJ-45 SG1200]
...
Vitesse de liaison
 a| 
Pour le SG120, choisissez l'un des modèles suivants :
...
Pour le SG1200, choisissez l'un des modèles suivants :
...
* 40 GbE
* 100 GbE
* 200 GbE (carte réseau 200 GbE uniquement)


*Remarque :* Pour le SG1200, les vitesses 10 et 25 GbE nécessitent l’utilisation d’adaptateurs QSA.
...
Port de gestion BMC SG120 :

image::../media/sg120_bmc_management_port.png[port de gestion SG120]

Port de gestion BMC SG1200 :

image::../media/sg1200_bmc_management_port.png[Port de gestion BMC SG1200]
...
Lorsque link:configuring-network-links.html["configuration des liens réseau"] pour les appliances SG120 et SG1200, vous pouvez utiliser l'agrégation de liens pour les ports connectés au réseau Grid et au réseau client (en option), ainsi que pour les ports de gestion 1-GbE1/10-GbE connectés au réseau d'administration (en option). L'agrégation de liens contribue à protéger vos données en fournissant des chemins redondants entre les réseaux StorageGRID et l'appliance.
...
Le mode d'agrégation de ports fixes est la configuration par défaut pour les ports réseau. Les figures illustrent comment les ports réseau des SG1200 ou SG120 sont agrégés en mode d'agrégation de ports fixes.

SG120 :

image::../media/sg120_fixed_port.png[Mode de liaison à port fixe SG120]

SG1200 :

image::../media/sg1200_fixed_port.png[Mode de liaison à port fixe SG1200]
...
image::../media/sg120_aggregate_ports.png[Mode de liaison de port agrégé SG120]

SG1200 :

image::../media/sg1200_aggregate_ports.png[Mode de liaison de port agrégé SG1200]
...
image::../media/sg120_bonded_management_ports.png[Ports de gestion de réseau agrégés SG120]

SG1200 :

image::../media/sg1200_bonded_management_ports.png[Ports de gestion de réseau agrégés SG1200]
