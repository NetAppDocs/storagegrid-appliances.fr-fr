...
Vous ne pouvez pas utiliser de ports remappés pour les terminaux d'équilibrage de charge. Si vous devez supprimer un port remappé, suivez les étapes de la section https://docs.netapp.com/us-en/storagegrid-118/maintain/removing-port-remaps.html["Supprimer les mappages de port"^].
