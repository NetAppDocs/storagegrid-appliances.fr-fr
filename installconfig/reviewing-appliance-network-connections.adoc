...
* link:gathering-installation-information-sg120-and-sg1200.html["SG120 et SG1200"]
...
* *Réseau de gestion pour SANtricity* (optionnel pour les appliances de stockage, non requis pour les SGF6112 et SGF6212) : ce réseau permet d’accéder à SANtricity System Manager, permettant de surveiller et de gérer les composants matériels de l’appliance et du tiroir du contrôleur de stockage. Ce réseau de gestion peut être identique au réseau d’administration de StorageGRID ou être un réseau de gestion indépendant.
* *Réseau de gestion BMC* (optionnel pour les appliances SG6000, SG6100, SG6200 et de services) : ce réseau permet d’accéder au contrôleur de gestion de la carte mère des appliances SG6000, SG6100, SG6200 et de services, et ainsi de surveiller et de gérer les composants matériels de l’appliance. Ce réseau de gestion peut être identique au réseau d’administration de StorageGRID ou constituer un réseau de gestion indépendant.
+
