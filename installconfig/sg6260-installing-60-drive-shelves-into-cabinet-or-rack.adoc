...
---
= Installez les tiroirs à 60 disques pour un SG6260
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Lors de l'installation du châssis de contrôleur E4000 ou des tiroirs d'extension optionnels, installez le matériel du bas vers le haut de la baie ou de l'armoire afin d'éviter que l'équipement ne bascule. Pour garantir que les équipements les plus lourds se trouvent en bas de l'armoire ou de la baie, installez le contrôleur SG6200-CN au-dessus du châssis de contrôleur E4000 et des tiroirs d'extension.
...
. Passez aux instructions d'installation du SG6200-CN dans une armoire ou un rack.
