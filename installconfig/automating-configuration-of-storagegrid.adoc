...
NOTE: Vous pouvez également configurer le système à l'aide du https://docs.netapp.com/us-en/storagegrid-118/primer/exploring-grid-manager.html["Gestionnaire de grille"^] ou le link:overview-of-installation-rest-apis.html["API d'installation"].
