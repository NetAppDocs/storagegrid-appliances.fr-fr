...
---
= Démarrage rapide pour l'installation de l'appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** link:installing-appliance-in-cabinet-or-rack-sg120-and-sg1200.html["SG120 et SG1200"]
...
. link:accessing-and-configuring-santricity-system-manager.html["Accès à SANtricity System Manager et configuration de celui-ci"] (SG6260, SG6160, SG5700, SG5800 et SG6000)
. link:configuring-bmc-interface.html["Configurez l'interface BMC"] (SG6200, SG6100, SG6000 et appareils de service)
...
** link:optional-changing-raid-mode.html["Changer le mode RAID"](SG6260, SG6160, SG6000, SG5860 et SG5760)
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Cinq"] Configuration
[role="quick-margin-para"]
Une fois tous les nœuds déployés, utilisez le Grid Manager pour link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html["Configurez la grille et terminez l'installation"^].
