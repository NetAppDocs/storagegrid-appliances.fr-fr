...
---
= Dépannage de l'installation matérielle d'un SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
== [[view-boot-codes]]Afficher les codes de démarrage (SGF6212 et SG6260 uniquement)
...
.. Vérifiez que les quatre câbles d'interconnexion entre le contrôleur SG6200-CN et les deux contrôleurs de stockage sont correctement connectés.
...
== [[view-error-codes]]Afficher les codes d'erreur (SGF6212 et SG6260 uniquement)
...
=== Les tiroirs d'extension n'apparaissent pas dans Appliance Installer (SG6260)
...
. Vérifiez que vous avez bien mis sous tension les tiroirs d'extension. Voir link:connecting-power-cords-and-applying-power.html["Branchez les cordons d'alimentation et mettez l'appareil sous tension (SG6200)"].
. Si vous avez besoin d'aide pour résoudre un problème, contactez le support technique.
