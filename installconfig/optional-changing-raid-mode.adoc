...
---
= Modifier le mode RAID pour un SG5760, SG5860, SG6000, SG6160 ou SG6260
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Vous pouvez modifier le mode RAID sur les équipements suivants :
...
** Le DDP assure la protection contre la perte des tiroirs dans les appareils SG5760, SG5860, SG6160 et SG6260.
+
