...
---
= Accédez à l'installateur d'appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120
--
image::../media/sg120_admin_network_port.png[Port réseau d'administration sur le SG120]
...
.SG1200
--
image::../media/sg1200_admin_network_port.png[Port réseau d'administration sur le SG1200]
...
.SG6200-CN
--
image::../media/sg6200_cn_admin_network_port.png[Port réseau d'administration sur le contrôleur SG6200-CN]
...
.SGF6212
--
image::../media/sgf6212_admin_network_port.png[Port réseau d'administration sur le SGF6212]
...
image::../media/sg120_link_local_port.png[Connexion locale SG120]
...
image::../media/sg1200_link_local_port.png[Connexion locale SG1200]
...
.SG6200-CN
--
Connectez un ordinateur portable de service directement au port RJ-45 le plus à droite du contrôleur SG6200-CN, à l'aide d'un câble Ethernet.

image::../media/sg6200_cn_link_local_port.png[Emplacement du port de gestion pour SG6200-CN]
...
image::../media/sgf6212_link_local_port.png[Connexion locale SGF6212]
