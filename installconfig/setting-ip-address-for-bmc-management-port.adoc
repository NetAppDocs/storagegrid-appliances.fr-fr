...
---
= Définissez l'adresse IP du port de gestion BMC sur un appareil StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120
--
image::../media/sg120_bmc_management_port.png[Port de gestion BMC SG120]
...
image::../media/sgf6212_bmc_management_port.png[Port de gestion BMC SGF6212]

_SG6200-CN_ :

image::../media/sg6200_cn_bmc_management_port.png[Port de gestion BMC SG6200-CN]
