...
---
= Déballez les boîtes de l'appliance StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
--
image::../media/sg120_front_view.png[Lecteurs avant SG120 et SG1200 appliances]
...
* *Matériel SG6260*
+
Contrôleur SG6200-CN::
+
--
image::../media/s25_front_with_ssds.png[Contrôleur SG6200-CN]

--
Tiroir contrôleur E4000 sans disque installé::
+
--
image::../media/de460c_table_size.gif[Contrôleur E4000 4U]

--
Deux panneaux avant (non illustrés)::
+
--
image::../media/rail_kit.gif[Kit de rails]
...
+
--
image::../media/sg5760_drive.gif[60 disques NL-SAS]

--
Quatre poignées::
+
--
image::../media/handles.gif[Poignées E4000]
...
+
--
image::../media/s25_front_with_ssds.png[Lecteurs avant SGF6212 appliance]
