...
---
= Remplacez le bloc d'alimentation dans l'étagère du contrôleur de stockage ou le tiroir d'extension (SG6260)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer un bloc d'alimentation dans une étagère de contrôleur de stockage SG6260 ou tiroir d'extension (DE460C).
