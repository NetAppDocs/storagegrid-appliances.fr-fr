...
---
= Mise à niveau automatique du firmware des disques SG6260 lors du redémarrage de l'appareil
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Pendant une link:../sg6200/upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6260.html["Mise à niveau du système d'exploitation SANtricity"] utilisation du mode de maintenance
