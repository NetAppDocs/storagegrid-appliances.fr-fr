...
.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Retirez l'appareil défectueux de l'armoire ou du rack"].
...
+
image::../media/sgf6212_front_with_ssds.png[Emplacements des ventilateurs]
...
CAUTION: Pour conserver les données sur les disques, veillez à insérer les disques SSD dans les mêmes emplacements que ceux qu'ils occupaient dans l'appliance défaillante. Dans le cas contraire, l'Appliance Installer affichera un message d'avertissement et vous devrez insérer les disques dans les bons emplacements et redémarrer l'appliance avant qu'elle puisse réintégrer la grille.

.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Installez l'appareil de remplacement dans l'armoire ou le rack"].
...
* link:../installconfig/troubleshooting-hardware-installation-sg6200.html#view-boot-codes["Afficher les codes de démarrage de l'appareil"]
