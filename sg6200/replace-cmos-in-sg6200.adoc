...
summary: Utilisez cette procédure pour remplacer les piles bouton CMOS sur la carte mère. 
---
= Remplacez les piles CMOS SGF6212 ou SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Utilisez cette procédure pour remplacer les piles bouton CMOS sur la carte mère.

.Description de la tâche
Pour éviter toute interruption de service, assurez-vous que tous les autres nœuds de stockage sont connectés au grid avant de procéder au remplacement de la pile CMOS, ou effectuez ce remplacement lors d'une fenêtre de maintenance planifiée où une interruption de service est acceptable. Consultez les informations sur https://docs.netapp.com/us-en/storagegrid/monitor/monitoring-system-health.html#monitor-node-connection-states["contrôle de l'état de connexion du nœud"^].


CAUTION: Si vous avez déjà utilisé une règle ILM qui ne crée qu'une seule copie d'un objet, vous devez remplacer les piles lors d'une fenêtre de maintenance planifiée, car vous pourriez perdre temporairement l'accès à ces objets pendant cette procédure. Consultez les informations sur https://docs.netapp.com/us-en/storagegrid/ilm/why-you-should-not-use-single-copy-replication.html["pourquoi ne pas utiliser la réplication à copie unique"^].

.Avant de commencer
* Vous avez link:verify-component-to-replace.html["vérifié l'appareil sur lequel les piles CMOS doivent être remplacées"].
* Vous avez link:locating-sg6200-in-data-center.html["localisé physiquement l'appareil SGF6212 ou le contrôleur SG6200-CN"] où les piles CMOS doivent être remplacées dans le centre de données.
...
. Retirez la première pile CMOS.
+
.. Repérez la pile CMOS sur la carte mère.
.. Utilisez votre doigt ou un levier en plastique pour extraire le clip de retenue de la batterie et le retirer de la prise.
+
image::../media/drw_s2025_cmos_battery_replace_ieops-2558.svg[Retrait de la pile CMOS de la carte mère]

.. Retirez la batterie et mettez-la au rebut de façon appropriée.


. Installez la pile CMOS de remplacement.
+
.. Retirez la pile CMOS de remplacement de son emballage.
...
. Répétez ces étapes pour la deuxième pile CMOS.
...
. Rétablissez la connectivité réseau BMC de l'appliance en utilisant l'une des options suivantes :
+
