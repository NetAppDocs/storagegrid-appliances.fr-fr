...
---
= Remplacez le boîtier du ventilateur dans le tiroir du contrôleur de stockage ou le tiroir d'extension (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer le boîtier du ventilateur dans un SG6260.
