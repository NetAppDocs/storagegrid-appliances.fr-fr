...
summary: 'Vous pouvez éteindre l"appareil SG6200 et le rallumer pour effectuer la maintenance.' 
---
= Mise hors tension et sous tension de l'appareil SGF6212 ou du contrôleur SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez éteindre l'appareil SGF6212 ou le contrôleur SG6200-CN et les rallumer pour effectuer la maintenance.



== Mettez hors tension l'appareil SGF6212 ou le contrôleur SG6200-CN
...
== Mettez sous tension le SGF6212 ou le SG6200-CN et vérifiez son fonctionnement

Mettez le contrôleur sous tension après la fin de la maintenance.

.Avant de commencer
* Vous avez link:reinstalling-sg6200-into-cabinet-or-rack.html["installez le contrôleur dans une armoire ou un rack - effectué"] connecté les câbles de données et d'alimentation.
* Vous avez link:locating-sg6200-in-data-center.html["situé physiquement le contrôleur dans le data center"].
