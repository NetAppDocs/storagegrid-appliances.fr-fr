...
summary: 'Vous devrez peut-être remplacer la carte d"interface réseau (NIC) dans le SGF6212 si elle ne fonctionne pas de manière optimale ou si elle est défectueuse.' 
---
= Remplacez la carte réseau interne du SGF6212 ou du SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous devrez peut-être remplacer la carte d'interface réseau (NIC) interne du SGF6212 ou du SG6200-CN si elle ne fonctionne pas de manière optimale ou si elle est défectueuse.
...
* Vous avez link:locating-sg6200-in-data-center.html["localisé physiquement l'appareil SGF6212 ou le contrôleur SG6200-CN"] où vous remplacez la carte réseau dans le centre de données.
+
...
+
image:../media/drw_s2025_io_numbers_ieops-2554.svg["Emplacement des cartes réseau dans l'appareil"]
