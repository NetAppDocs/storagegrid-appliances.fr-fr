...
summary: 'Pour les contrôleurs de stockage utilisant SANtricity OS 08.42.20.00 \(11.42\) ou une version ultérieure, vous pouvez utiliser le gestionnaire de grille ou le mode de maintenance pour appliquer une mise à niveau.' 
---
= Mettez à niveau le système d'exploitation SANtricity sur les contrôleurs de stockage SG6200 à l'aide de Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez utiliser le Gestionnaire de grille ou le mode maintenance pour appliquer une mise à niveau.
...
** Sélectionnez un ou plusieurs boutons *Approuver* pour ajouter un ou plusieurs nœuds à la file d'attente de mise à niveau du système d'exploitation SANtricity. Le bouton *Approuver* est désactivé si l'état n'est pas Nominal.
+
...
Aucune autre action n'est requise.
 ...
 a| 
La mise à niveau du système d'exploitation SANtricity n'est pas applicable à ce nœud.
 a| 
Le nœud ne dispose d'aucun contrôleur de stockage qui peut être géré par le système StorageGRID. Terminez le processus de mise à niveau sans mettre à niveau le nœud affichant ce message.
 ...
 a| 
Le fichier SANtricity OS n'est pas compatible avec ce nœud.
 a| 
...
* link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6260.html["Mettez à niveau le système d'exploitation SANtricity sur les contrôleurs SG6200 en mode maintenance"]
