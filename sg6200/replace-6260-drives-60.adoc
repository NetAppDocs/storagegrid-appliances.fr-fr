...
summary: 'Remplacez un disque d"un E4000 par un tiroir de 60 disques.' 
---
= Remplacez le disque dans le tiroir du contrôleur de stockage ou le tiroir d'extension (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
*** Dans Grid Manager, sélectionnez *Nœuds* > *_appliance node_* > *SANtricity System Manager*. Les informations du contrôleur se trouvent sur le https://docs.netapp.com/us-en/storagegrid/monitor/viewing-santricity-system-manager-tab.html["Onglet Gestionnaire système SANtricity"].
