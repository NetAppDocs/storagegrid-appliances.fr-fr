...
---
= Mettez à niveau le firmware des disques SG6200 à l'aide de SANtricity System Manager en utilisant la méthode hors ligne (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Cette procédure ne s'applique pas aux SSD NVMe du SG6200-CN, qui sont mis à jour lors des mises à niveau logicielles de StorageGRID. Seuls les disques du E4000 peuvent être mis à jour à l'aide de cette procédure.
...
** Utilisez le Grid Manager et sélectionnez *Nodes* > *_Storage Node_* > *SANtricity System Manager*
