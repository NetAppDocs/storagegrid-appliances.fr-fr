...
---
= Vérifiez le composant à remplacer dans le SGF6212 ou le SG6200-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:turning-sg6200-identify-led-on-and-off.html["Allumez le voyant d'identification de l'appareil"]
