...
---
= Procédures d'entretien courantes pour les appliances StorageGRID
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../sg6200/index.html["Maintenance de l'appareil SG6200"]
...
* link:../sg120-1200/index.html["Assurer la maintenance des appliances SG120 et SG1200"]
