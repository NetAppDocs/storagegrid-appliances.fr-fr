...
.Étapes
Accédez à l'outil Modifier IP et mettez à jour les paramètres MTU comme décrit dans https://docs.netapp.com/us-en/storagegrid-118/maintain/changing-nodes-network-configuration.html["Modifier la configuration réseau du nœud"^].
