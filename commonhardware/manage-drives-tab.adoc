...
---
= Utilisez l'onglet Gérer les lecteurs pour les appliances StorageGRID SG110, SG120, SG1100, SG1200, SG6100 et SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Dans le Gestionnaire de grille, sélectionnez *Nœuds* > *_data center_*.
